module.exports = class Data1659610520719 {
  name = 'Data1659610520719'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "uri" text, "image_uri" text, "token_id" integer NOT NULL, "is_listed" boolean, "fish_id" text, "owner_id" character varying, "contract_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
